	...
	Main.Page = (function() {
		...
		function Page() {
			...
			mosq.onmessage = function(topic, payload, qos){
				...
				console.log(acao);
				if (acao == "K0ON")
					document.getElementById("Key0But").style.opacity = "100";
				if (acao == "K0OFF")
					document.getElementById("Key0But").style.opacity = "0";
				
				if (acao == "K1ON")
					document.getElementById("Key1But").style.opacity = "100";
				if (acao == "K1OFF")
					document.getElementById("Key1But").style.opacity = "0";
				
				if (acao == "K2ON")
					document.getElementById("Key2But").style.opacity = "100";
				if (acao == "K2OFF")
					document.getElementById("Key2But").style.opacity = "0";
